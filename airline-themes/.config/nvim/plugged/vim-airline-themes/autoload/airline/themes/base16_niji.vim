" By rgmfn
" Based on Base16 OneDark vim-airline-theme (https://github.com/dawikur/base16-vim-airline-themes)
" By Lalit Magant (http://github.com/tilal6991)
" For vim-airline (https://github.com/vim-airline/vim-airline)

let s:scheme_slug = substitute("niji", "-", "_", "g")
...
let s:gui06 = '#b6bdca'
let s:gui07 = '#c8ccd4'
let s:gui08 = '#b90b4a' " reimu
let s:gui09 = '#ffae42' " petra
let s:gui0A = '#d4af37' " luca
let s:gui0B = '#258e70' " pomu
let s:gui0C = '#79cfb8' " finana
let s:gui0D = '#248ec7' " ike
let s:gui0E = '#a660a7' " shu
let s:gui0F = '#dc3753' " rosemi
...
" [left and right bar text color,   left and right bar bg color  ]
" [middle-right bar text color,     middle-right bar bg color    ]
" [middle text color,               middle bg color              ]

" [middle bar text (file modified), middle bar bg (file modified)]
